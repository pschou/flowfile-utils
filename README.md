...
```
# nifi-stager -h
NiFi Stager (github.com/pschou/flowfile-utils, version: 0.1.20230203.1255)
...
```
# nifi-sender -h
NiFi Sender (github.com/pschou/flowfile-utils, version: 0.1.20230203.1255)
...
```
# nifi-unstager -h
NiFi Unstager (github.com/pschou/flowfile-utils, version: 0.1.20230203.1255)
...
```
# nifi-reciever -h
NiFi Reciever (github.com/pschou/flowfile-utils, version: 0.1.20230203.1255)
...
```
# nifi-diode -h
NiFi Diode (github.com/pschou/flowfile-utils, version: 0.1.20230203.1255)

...
require (
	...
	github.com/pschou/go-flowfile v0.0.0-20230224120541-5e078975f6c6
...
require (
	github.com/ShoshinNikita/go-disk-buffer v0.3.0 // indirect
	...
	github.com/pschou/go-memdiskbuf v0.0.0-20230224121005-08614f5e4d45 // indirect
